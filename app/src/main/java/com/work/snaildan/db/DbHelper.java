...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS table_account" + "(_id INTEGER PRIMARY KEY AUTOINCREMENT ,AccMoney MONEY,NoteDate INTEGER,Type VARCHAR(10),SortCode VARCHAR(10),Remark TEXT)");
